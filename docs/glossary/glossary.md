...
| **Programa Residencial** | Regime de internato de 9 meses localizado no campus em Águas Lindas de Goiás / DF, exclusivo para homens adultos (≥ 18 anos). Dividido em Fase I (6 meses de fundamentação) e Fase II (3 meses de transição). | Tabela `triagens` com `program_interest = 'residencial'`. |
| **Programa Vencedores em Casa** | Programa de aconselhamento à distância com duração de 6 meses, voltado para homens que não podem se internar, mulheres em luta com pecado sexual e adolescentes maduros (≥ 16 anos). | Tabela `triagens` com `program_interest = 'online'`. |
